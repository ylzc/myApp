...
deleteFolderRecursive(androidIonicAngular);
deleteFolderRecursive(androidIonicAngularUiRouter);
deleteFolderRecursive(iosIonicAngular);
deleteFolderRecursive(iosIonicAngularUiRouter);
